...
def generate_openai_insights(job_desc, resume):
    ...
    Provide:
    1. Why the candidate is a good fit for the job. (Short and comprehensive paragraph)
    2. What are the strengths of this candidate's profile? (clear to read bullets)
    """
